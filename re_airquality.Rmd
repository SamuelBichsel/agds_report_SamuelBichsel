...
#average, min and max Temp for these 5 months 
```{r}

#include these in the T graph. Important because they allow us to better grasp how the temperature is across the observed 5 months
#separate graph of monthly average T (instead of Solar Radiation) and only include solar Radiation in the correlation plot? Perhaps...  

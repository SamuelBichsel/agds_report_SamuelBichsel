...
Because the linear regression model lacks flexibility to predict data points that are not linearly correlated to the predictors, while knn can by using neighboring points. 
